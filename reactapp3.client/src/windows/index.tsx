...
import { focusedElement } from "../store/atoms";
...
export default function WindowFrame({ name, cssName, window, onClose, children }: any) {
    const focused = useRecoilValue(focusedElement);
    const refCloseBtn = React.useRef<HTMLSpanElement>(null);
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <WindowHeader
                        className={`flex items-center justify-between handle windowHeader${focused === name ? "" : " -inactive"
                            }`}
                    >
                        <span
...
export { Welcome, About, Weather, Credits, Run, Documents };